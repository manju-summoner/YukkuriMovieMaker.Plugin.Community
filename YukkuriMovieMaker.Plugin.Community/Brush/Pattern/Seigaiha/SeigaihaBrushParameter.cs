...
namespace YukkuriMovieMaker.Plugin.Community.Brush.Pattern.Seigaiha
{
    ...
    {
        [Display(Name = nameof(Texts.GradientEnabled), ResourceType = typeof(Texts))]
        [ToggleSlider]
        ...
        [Display(Name = nameof(Texts.OuterColor), ResourceType = typeof(Texts))]
        [ColorPicker]
        [GradientColorVisible]
        public Color OuterColor { get => outerColor; set => Set(ref outerColor, value); }
        Color outerColor = Colors.White;

        [Display(Name = nameof(Texts.InnerColor), ResourceType = typeof(Texts))]
        [ColorPicker]
        [GradientColorVisible]
