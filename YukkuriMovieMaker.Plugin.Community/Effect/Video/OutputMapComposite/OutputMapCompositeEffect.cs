...
{
    [VideoEffect(nameof(Texts.OutputMapCompositeEffectName), [VideoEffectCategories.Composition], ["合成", "composite", "blend", "map", "マップ", "lerp", "output", "出力", "CustomValue"], IsAviUtlSupported = false, ResourceType = typeof(Texts))]
