...
public sealed class NoiseNode : NodeLogic
{
    ...
    protected override async Task Calculate()
    {
        ...
        await _brush.SetValue("NoiseParameter.Strength", GetInput<float>(nameof(Strength)));
        await _brush.SetValue("NoiseParameter.Threshold", GetInput<float>(nameof(Threshold)));
        await _brush.SetValue("NoiseParameter.Levels", GetInput<float>(nameof(Levels)));
        await _brush.SetValue("NoiseParameter.Octaves", GetInput<float>(nameof(Octaves)));
        await _brush.SetValue("NoiseParameter.X", GetInput<float>(nameof(X)));
        await _brush.SetValue("NoiseParameter.Y", GetInput<float>(nameof(Y)));
        await _brush.SetValue("NoiseParameter.Z", GetInput<float>(nameof(Z)));
        await _brush.SetValue("NoiseParameter.SpeedX", GetInput<float>(nameof(SpeedX)));
        await _brush.SetValue("NoiseParameter.SpeedY", GetInput<float>(nameof(SpeedY)));
        await _brush.SetValue("NoiseParameter.SpeedZ", GetInput<float>(nameof(SpeedZ)));
        await _brush.SetValue("NoiseParameter.ScaleX", GetInput<float>(nameof(ScaleX)));
        await _brush.SetValue("NoiseParameter.ScaleY", GetInput<float>(nameof(ScaleY)));
        await _brush.SetValue("NoiseParameter.ScaleZ", GetInput<float>(nameof(ScaleZ)));
        await _brush.SetValue("NoiseParameter.Angle", GetInput<float>(nameof(Angle)));
