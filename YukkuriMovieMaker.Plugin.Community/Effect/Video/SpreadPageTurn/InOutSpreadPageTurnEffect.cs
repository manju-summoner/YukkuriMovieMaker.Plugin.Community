...
{
    [VideoEffect(nameof(Texts.InOutSpreadPageTurnEffectName), [VideoEffectCategories.Transition], ["見開きめくり", "本めくり", "ページめくり", "book", "spread", "page", "turn", "curl"], ResourceType = typeof(Texts))]
