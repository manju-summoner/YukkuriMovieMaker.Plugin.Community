...
{
    internal class DistantDiffuseLightingParameter : LightingParameterBase
    {
        ...
        public DistantDiffuseLightingParameter() : base()
        {

        }

        public DistantDiffuseLightingParameter(SharedDataStore store) : base(store)
        {
