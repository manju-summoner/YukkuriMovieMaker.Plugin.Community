...
{
    [VideoEffect(nameof(Texts.ChannelRouterEffectName), [VideoEffectCategories.Composition], ["channel router", "channel combiner", "set channel", "composite channels", "channel composite", "チャンネルルーター", "分岐とチャンネル合成", "チャンネル合成", "通道路由", "通道合成", "채널 라우터", "채널 합성", "CustomValue"], IsAviUtlSupported = false, ResourceType = typeof(Texts))]
