...
{
    internal class LuminanceMaskEffectProcessor : VideoEffectProcessorBase
    {
        readonly IGraphicsDevicesAndContext devices;
        readonly LuminanceMaskEffect item;
        LuminanceToAlpha? luminanceToAlphaEffect;
        ...
        public LuminanceMaskEffectProcessor(IGraphicsDevicesAndContext devices, LuminanceMaskEffect item) : base(devices)
        {
        ...
        {
            if (alphaMaskEffect is null || blurEffect is null || colorMatrixEffect is null || luminanceToAlphaEffect is null)
            ...
            if (isBrushChanged)
            {
                ...
                luminanceToAlphaEffect.SetInput(0, commandList, true);
            }
            isFirst = false;
            this.blur = blur;
            this.type = type;
        ...
        {
            luminanceToAlphaEffect = new LuminanceToAlpha(devices.DeviceContext);
            disposer.Collect(luminanceToAlphaEffect);
            ...
            using (var output = luminanceToAlphaEffect.Output)
                colorMatrixEffect.SetInput(0, output, true);
        ...
        {
            luminanceToAlphaEffect?.SetInput(0, null, true);
