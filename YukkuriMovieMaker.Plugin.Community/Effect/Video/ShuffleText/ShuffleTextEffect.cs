...
using YukkuriMovieMaker.Plugin.Community.Effect.Video.ShuffleText.ShffleTextEnum;
using YukkuriMovieMaker.Plugin.Effects;

namespace YukkuriMovieMaker.Plugin.Community.Effect.Video.ShuffleText
{
    [VideoEffect(nameof(Texts.ShuffleTextEffectDefaultName), [VideoEffectCategories.Transition], ["Shuffle Text","シャッフルテキスト","shahhuru tekisuto"], isAviUtlSupported: false, ResourceType =typeof(Texts))]
    internal class ShuffleTextEffect : VideoEffectBase
    {
        ...
        [EnumComboBox]
        public Mode Enum_Mode { get => mode_Enum; set => Set(ref mode_Enum, value); }
        Mode mode_Enum = Mode.Alphabet;
        ...
        [ToggleSlider]
        [ShowPropertyEditorWhen(nameof(Enum_Mode), Mode.Custom)]
