...
{
    [VideoEffect(nameof(Texts.OutputCompositeEffectName), [VideoEffectCategories.Branch], ["分岐", "branch", "合成", "composite", "blend"], IsAviUtlSupported = false, ResourceType = typeof(Texts))]
