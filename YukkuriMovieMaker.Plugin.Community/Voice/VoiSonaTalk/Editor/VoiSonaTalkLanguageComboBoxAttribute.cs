...
{
    internal class VoiSonaTalkLanguageComboBoxAttribute : PropertyEditorAttribute2, IPropertyEditorForVoiceParameterAttribute
    {
        ...
        public override void SetBindings(FrameworkElement control, ItemProperty[] itemProperties)
        {
            ...
            if (VoiceDescription?.Speaker is not VoiSonaTalkVoiceSpeaker speaker)
                return;
            comboBox.ItemsSource = VoiSonaTalkAPIHelper.GetLanguagesByVoiceName(speaker.ID);
